...
save(scenariogrid, file="./VarselCompStudy/Additional_file/Results/Results3/scenariogrid.Rda") 
...
save(Results, file="./VarselCompStudy/Additional_file/Results/Results3/Results_AnalysisCluster.Rda")
